...
* **Hangman Game (Python) - [Harvard University's CS50 Introduction to Programming with Python](https://courses.edx.org/certificates/bc656353926d4dbab76a5a51ec5052bc)**:
    * Developed a classic **[Hangman game using Python](https://github.com/SpadaSchiavonesca/Hangman-Game-in-Python)**, as part of Harvard University's CS50 Introduction to Programming with Python course.
