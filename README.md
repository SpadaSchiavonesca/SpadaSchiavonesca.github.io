...
*   **Azure VM and Web Server Deployment**: <a href="https://scribehow.com/shared/Creating_a_Virtual_Machine_in_Azure_Portal__fYuQoaltQpCPlWh0tOfCaw" target="_blank">Azure VM Web Server</a>
    *   Created a **virtual machine in Azure**. Validated Azure proficiency through [hands-on experience](https://coursera.org/verify/IWZG0IU9HQ90).
